...
# =========================
# ВЕБ-СЕРВЕР И SELF-PING (ДЛЯ 24/7)
# =========================
app = Flask('')
...
def self_ping():
    """Функция, которая раз в 10 минут заходит на сайт бота, чтобы он не уснул"""
    # Замените на ваш актуальный URL от Render, если он изменится
    url = "https://promobot-taiu.onrender.com/"
    while True:
        try:
            requests.get(url)
